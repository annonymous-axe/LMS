...
/**
 * BatchCard Component - Ultra Modern Enhanced Version
 * Stunning, Professional, and Highly Captivating Design
 */
export const BatchCard = ({
  ...
  const statusConfig = {
    ...
    upcoming: {
      bg: 'bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-blue-900/40 dark:to-cyan-900/40',
    ...
    <>
      <div 
        className={`
          ...
          hover:shadow-2xl hover:shadow-gray-300/60 dark:hover:shadow-black/60
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-500/0 via-purple-500/0 to-pink-500/0 group-hover:from-blue-500/5 group-hover:via-purple-500/5 group-hover:to-pink-500/5 transition-all duration-700 pointer-events-none" />
        ...
        {/* Header Section */}
        <div className="relative px-6 py-5 border-b border-gray-100/80 dark:border-gray-700/80 bg-gradient-to-r from-gray-50/50 via-transparent to-transparent dark:from-gray-900/30">
            ...
            <div className="flex items-start gap-4 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-3 mb-1 flex-wrap">
                  <h3 className="text-lg font-bold bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 dark:from-white dark:via-gray-100 dark:to-white bg-clip-text text-transparent leading-tight group-hover:from-blue-600 group-hover:to-purple-600 transition-all duration-300">
                    {name}
                  </h3>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed flex items-center gap-2">
        ...
        <div className="relative px-6 py-5">
          ...
          <div className="grid grid-cols-2 gap-3 mb-5">
            {/* Start Date */}
            <div className="group/item flex items-center gap-3 p-3 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-800/10 border border-blue-100 dark:border-blue-800/30 hover:shadow-md hover:scale-105 transition-all duration-300">
              ...
              <div className="min-w-0">
                <p className="text-xs font-medium text-blue-600 dark:text-blue-400">Start Date</p>
            ...
            {/* End Date */}
            {endDate && (
              <div className="group/item flex items-center gap-3 p-3 rounded-xl bg-gradient-to-br from-purple-50 to-purple-100/50 dark:from-purple-900/20 dark:to-purple-800/10 border border-purple-100 dark:border-purple-800/30 hover:shadow-md hover:scale-105 transition-all duration-300">
                ...
                <div className="min-w-0">
                  <p className="text-xs font-medium text-purple-600 dark:text-purple-400">End Date</p>
                  <p className="text-sm font-bold text-gray-900 dark:text-white truncate">
                    {endDate}
                  </p>
                </div>
            ...
            {/* Students */}
            <div className="group/item flex items-center gap-3 p-3 rounded-xl bg-gradient-to-br from-green-50 to-green-100/50 dark:from-green-900/20 dark:to-green-800/10 border border-green-100 dark:border-green-800/30 hover:shadow-md hover:scale-105 transition-all duration-300">
              ...
              <div className="min-w-0">
                <p className="text-xs font-medium text-green-600 dark:text-green-400">Students</p>
                <p className="text-sm font-bold text-gray-900 dark:text-white truncate">
            ...
            {/* Schedule */}
            {schedule && (
              <div className="group/item flex items-center gap-3 p-3 rounded-xl bg-gradient-to-br from-orange-50 to-orange-100/50 dark:from-orange-900/20 dark:to-orange-800/10 border border-orange-100 dark:border-orange-800/30 hover:shadow-md hover:scale-105 transition-all duration-300">
                ...
                <div className="min-w-0">
                  <p className="text-xs font-medium text-orange-600 dark:text-orange-400">Schedule</p>
                  <p className="text-sm font-bold text-gray-900 dark:text-white truncate">
                    {schedule}
                  </p>
                </div>
          ...
          {instructor && (
            <div className="mb-5 p-4 rounded-xl bg-gradient-to-r from-indigo-50/50 to-purple-50/50 dark:from-indigo-900/10 dark:to-purple-900/10 border border-indigo-100/50 dark:border-indigo-800/30">
              <p className="text-xs font-medium text-indigo-600 dark:text-indigo-400 mb-1 flex items-center gap-2">
        ...
        <div className="relative px-6 py-4 bg-gradient-to-br from-gray-50/80 to-gray-100/40 dark:from-gray-900/50 dark:to-gray-800/30 border-t border-gray-100/80 dark:border-gray-700/80 backdrop-blur-sm">
          <div className="flex gap-3 justify-end">
            {status === 'upcoming' && (
              <button className="group/btn px-5 py-2.5 border-2 border-blue-600 dark:border-blue-500 text-blue-600 dark:text-blue-400 rounded-xl hover:bg-blue-600 hover:text-white dark:hover:bg-blue-500 transition-all duration-300 text-sm font-semibold flex items-center gap-2 shadow-lg shadow-blue-500/20 hover:shadow-xl hover:shadow-blue-500/40 hover:scale-105">
...
/**
 * BatchList Component - Ultra Modern Enhanced Version
 * Beautiful filter system and empty states
 */
  ...
  return (
    <div className={className}>
              ...
              <button
                ...
                className={`
                  ...
                  ${filter === btn.value
                    ...
                    : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-2 border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-500 hover:shadow-md hover:scale-105'
                  }
                `}
              >
      ...
      {filteredBatches.length > 0 ? (
        ...
        <div className="relative bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-2xl p-16 text-center overflow-hidden">
